...
- **One word changing in a sentence highlights that word.** Lines that share
  too little to be a version of each other are left unmarked instead, since
  highlighting every word of a rewrite says nothing.
